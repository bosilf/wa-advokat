...
//       group: "profile",
//       description:
//         "Välj minst en och högst två yrkestitlar.",
...
//       validation: (rule) =>
//         rule.required().min(1).max(2).unique(),
//     }),
...
//     defineField({
//       name: "excerpt",
//       title: "Kort presentation",
//       type: "text",
//       rows: 3,
//       group: "profile",
//       description:
//         "En kort presentation som kan visas på medarbetarkort och i listor.",
...
//       group: "contact",
//       description:
//         "Telefonnummer får innehålla exempelvis +46, mellanslag och bindestreck.",
...
//       group: "qualifications",
//       description:
//         "Välj de rättsområden som medarbetaren arbetar med.",
...
//               type: "number",
//               description:
//                 "Lämna tomt om utbildningen fortfarande pågår.",
...
//       return {
//         title: name || "Namnlös medarbetare",
//         subtitle: role || "Ingen yrkestitel",
//         media,
//       };
//     },
//   },
