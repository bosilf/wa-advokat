...
//         <div>Filtrera</div>
//         {/* <div className="self-center">{isOpen ? <Icon className="w-5 h-5 text-black rotate-90 transition-all duration-300 self-center" /> : <ChevronRightIcon className="w-5 h-5 text-black transition-all duration-300 align-center justify-center" />}</div> */}
//       </div>
//       {isOpen && (
//         <div 
