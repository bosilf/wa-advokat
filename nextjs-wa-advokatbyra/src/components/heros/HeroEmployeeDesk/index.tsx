...
export default function HeroEmployeeDesk({
  eyebrow,
  title,
  image,
  employee
}: HeroEmployeeDeskProps) {
  ...
  return (
    <div className="flex flex-col h-full min-h-screen bg-footer">
      <div className="h-screen overflow-hidden grid grid-cols-2 grid-rows-2">
        ...
        <div className="relative row-start-1 row-span-2 col-start-2 flex flex-col ml-20 lg:mx-20 mt-40">
          <div className="z-200 h-full w-full absolute flex-1">
            <Image
